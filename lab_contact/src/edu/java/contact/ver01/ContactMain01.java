...
public class ContactMain01 {
    ...
    public static void main(String[] args) { 
        ...
        // static이 아닌 메서드들을 호출하기 위애서 객체를 생성할 필요가 있음.
    ...
    private void updateContact() {
        ...
        // NullPointerException 또는 ArrayIndexOfOutBoundsException
    ...
    private void selectContactByIndex() {
        ...
        if(contacts[index] != null) {
            ...
            System.out.println("해당 인덱스 정보 없음.");
        }
    ...
    private void insertNewContact() {
       ...
       if(count >= MAX_LENGTH) {
           System.out.println("해당 인덱스에 더이상 저장할 수 없음.");
           return;
       }
