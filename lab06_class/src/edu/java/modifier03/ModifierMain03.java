...
// 멤버 변수들의 값을 읽거나 수정하도록 허용하는 프로그램밍 방법.
...
public class ModifierMain03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        edu.java.modifier04.Member member = new edu.java.modifier04.Member("hello", "world"); 
        System.out.println(member.getterId());
        member.setterPassword("?");
        System.out.println(member.getterPassword());
    }
