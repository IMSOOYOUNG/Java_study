...
public class FileMain10 {
    ...
    public static void main(String[] args) {
        ...
        // (예) E:\study\lab-java\lab13_file\src\edu\java\file10
        ...
        // -> getPath 메서드는 File 객체가 생성될 때 상대 경로로 생성된 경우, getPath() 메서드는 상대 경로를 리턴.
        
        File file2 = new File("E:\\study\\lab-java\\lab13_file");
