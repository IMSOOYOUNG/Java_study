...
import java.sql.DriverManager; // SQL 드라이브(라이브러리) 관리자.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (rs.next()) { // ResultSet에 행(row)이 있는 경우                
                ...
                LocalDateTime createdDate = rs.getTimestamp(COL_CREATE_DATE).toLocalDateTime();
            ...
            // 사용했었던 리소스들을 해제(close) - 객체들이 생서된 반대 순서로 close.
